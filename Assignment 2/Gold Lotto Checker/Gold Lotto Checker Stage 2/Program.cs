...
namespace Gold_Lotto_Checker_Stage_2 {
    ...
    /// Draw numbers are randomly generated for the user to simulate
    /// the lottary in real life.
    /// 
    ...
    class Program {
        ...
        static void Main() {
            ...
            drawNumbers = GenerateNumbers(drawNumbers);
        ...
        /// <summary>
        /// Creates an array of 8 random number between 1 and 45.
        /// These numbers are checked to be sure that they are not doubles
        /// of the ones already in the array. 
        /// </summary>
        /// <param name="array"></param>
        /// <returns> an array of 8 random numbers </returns>
        static int [] GenerateNumbers(int [] array) {

            int randomValue = 0, arrayLength = 8;
            int lowerBound = 1, upperBound = 46;

            for(int i = 0; i < arrayLength; i++) {
                bool nonDuplicate = true;
                while(nonDuplicate){
                    randomValue = random.Next(lowerBound, upperBound);
                    nonDuplicate = CheckNoDuplicates(array, randomValue);
                    if (!nonDuplicate) {
                        array[i] = randomValue;
                    }
                }
        ...
        /// <summary>
        /// Goes through the array and determines if there is allready 
        /// that number within it. If it doesn't it allows the above
        /// function to include the number. 
        /// </summary>
        /// <param name="arr"></param>
        /// <param name="value"></param>
        /// <returns> a non duplicated number </returns>
